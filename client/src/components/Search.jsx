...
export default function Search() {
  ...
  return (
    <div className="flex flex-col md:flex-row">
      <div className="border-b border-gray-500 p-7 sm:border-r min-h-screen">
        <form onSubmit={handleSubmit} className=" flex flex-col gap-8">
          <div className="flex items-center gap-2">
            <label className=" text-lg font-semibold">Search Term:</label>
      ...
      <div className="w-full">
        <h1 className=" text-3xl font-semibold p-3 mt-5 border-b border-gray-500 ">Posts Results:</h1>
        <div className=" p-7 flex flex-wrap gap-4">
          ...
          {showMore && (
            <button onClick={handleShowMore} className=" text-teal-500 text-lg font-semibold hover:underline w-full">
              Show More
            </button>
          )}
        </div>
