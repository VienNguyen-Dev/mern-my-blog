            ...
            {userPosts.map((post) => (
              <Table.Body key={post._id} className=" divide-y">
                <Table.Row className=" bg-white dark:bg-gray-800 dark:border-gray-700">
                  ...
                  <Table.Cell>
                    <Link to={`/post/${post.slug}`} className=" font-semibold text-gray-900 dark:text-white">
                      {post.title}
                    </Link>
                  </Table.Cell>
        ...
        <Modal show={showModal} onClose={() => setShowModal(false)} size={"md"} popup>
          ...
          <Modal.Body>
            <div className="text-center">
              ...
              <h3 className="text-lg text-gray-500 dark:text-gray-400 font-normal mb-5">Are you sure you want to delete this post?</h3>
